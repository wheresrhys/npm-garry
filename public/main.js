...
/***/ function(module, exports, __webpack_require__) {
	...
	class Tree extends _preact.Component {
	    ...
	    render() {
	        ...
	        return (0, _preact.h)(
	            'div',
	            { 'class': "tree" + (tree.complete ? " complete" : " incomplete") },
	            (0, _preact.h)(
	                'p',
	                null,
	                tree.name,
	            ...
	            (0, _preact.h)(
	                'ul',
	                null,
	                Object.keys(tree.dependencies).map(dep => (0, _preact.h)(
	                    'li',
	                    null,
	                    (0, _preact.h)(Tree, { tree: tree.dependencies[dep] })
	                ))
	            )
	        );
	    }
	...
	(0, _preact.render)((0, _preact.h)(Tree, { top: 'true' }), document.getElementById('tree'));
